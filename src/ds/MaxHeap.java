...
/**
 * This subclass of Heap has a single property: Every node must be higher in comparation than the one on the left and right of it. This way, every root node is the highest node in the tree.
 * @author Jhon Edward Mora - Universidad ICESI - A00355710
 *
 * @param <T> Elements to be stored in this Heap, must be comparable as the comparation property is fundamental when using heaps.
 */
